...
▀▄▄▄▀▄▄▄▄▀▀▄▄▀▄▄▀▄▄▀▄▄▀▄▀▄▀▄▄▄▀▄▄▄▀▄▄▄▀
──────────────────────────────────────────────────
\033[1;95m{\033[1;96m×\033[1;95m} \033[1;93mNama : Anton Ibrahim ID
\033[1;95m{\033[1;96m×\033[1;95m} \033[1;93mFacebook \033[1;91m: \033[1;96mfacebook.com/PANGLIMA.gambarr"""
back = 0
threads = []
berhasil = []
cekpoint = []
...
def tokenz():
	...
	try:
		...
		os.system('xdg-open https://facebook.com/PANGLIMA.gambarr')
		bot_komen()
	except KeyError:
...
def bot_komen():
	...
	kom2 = ('Lo Gwe Doain Semoga Bahagia Bg Sama Cewemu😘')
	reac2 = ('LOVE')
